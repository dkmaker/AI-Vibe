...
if __name__ == "__main__":
    # Definer prompten der skal testes - denne gang en teknisk opgave
    # (Define the prompt to be tested - this time a technical task)
    prompt = "Forklar kort, hvordan man kan optimere prompts til forskellige LLM-arkitekturer. Giv konkrete eksempler."
